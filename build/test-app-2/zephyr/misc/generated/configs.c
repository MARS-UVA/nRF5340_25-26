...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAN_LOG_LEVEL_DBG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAN_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAN_MCP2515_INT_THREAD_STACK_SIZE, 1024);
